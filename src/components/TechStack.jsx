...
function TechStack() {
  return (
    <div
      ...
      data-aos="fade-down"
    >
      <p className=" text-[1.5rem] text-white dark:text-[#2D2E32] font-semibold linkItem after:bg-slate-500 relative md:text-[1.75rem]">
        Tech Stack
      </p>
      <div className=" w-[80%] flex flex-col gap-20 py-5 items-center justify-center mt-5  md:flex-row  h-28">
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="tooltip" data-tip="Typescript">
            <SiTypescript size={60} color="blue" />
          </div>
        </div>
