      ...
      <div className=" h-full w-full lg:w-[60%]  md:px-14 lg:px-20  ">
        <div className=" mt-4 pt-20 flex flex-col gap-10 px-5 md:mt-14 lg:pt-0 lg:mt-3  lg:w-fit">
          <div className="flex items-center gap-2 ">
            ...
            <span className="rotate text-3xl md:text-4xl inline-block w-fit h-fit cursor-pointer transition-all ">
              👋
            </span>
          </div>

          <p className=" text-[1.75rem] leading-[-.5rem] mt-8 md:text-[2rem]  lg:text-[2.3rem] lg:py-4 lg:w-full">
            I am{" "}
            <span className="font-bold text-[#40e9ff] dark:text-[#35d3e7]">
              Sian Malik,
            </span>{" "}
            a passionate Front-End{" "}
            <span className="font-bold text-[#40e9ff] dark:text-[#35d3e7]">
              Developer
            </span>{" "}
