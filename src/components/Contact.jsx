  ...
  return (
    <div className='h-screen w-screen mt-20 flex flex-col items-center justify-center gap-10 px-2'>
       ...
       <div className='flex gap-5 mt-5'>
           <a  href='mailto:sianmalik2418@gmail.com' target='_blank' className='flex items-center hover:bg-cyan-400 transition-all cursor-pointer gap-4 py-3 px-4 border-2 border-zinc-600 text-white dark:text-[#2D2E32] md:px-6 md:py-4 md:text-xl'>
